...
package com.deanlib.ootb.zxing;
...
import com.deanlib.ootb.zxing.camera.CameraManager;
import com.deanlib.ootb.zxing.decode.DecodeThread;
import com.deanlib.ootb.zxing.utils.BeepManager;
import com.deanlib.ootb.zxing.utils.CaptureActivityHandler;
import com.deanlib.ootb.zxing.utils.InactivityTimer;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    public static final String KEY_WIDTH_INT = "width";
    public static final String KEY_HEIGHT_INT = "height";
    public static final String KEY_RESULT_TEXT_STRING = "text";
    public static final String KEY_RESULT_FORMAT_STRING = "format";
    public static final String KEY_RESULT_TIMESTAMP_LONG = "timestamp";
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        bundle.putInt(KEY_WIDTH_INT, mCropRect.width());
        bundle.putInt(KEY_HEIGHT_INT, mCropRect.height());
        bundle.putString(KEY_RESULT_FORMAT_STRING, rawResult.getBarcodeFormat().toString());
        bundle.putString(KEY_RESULT_TEXT_STRING, rawResult.getText());
        bundle.putLong(KEY_RESULT_TIMESTAMP_LONG, rawResult.getTimestamp());
